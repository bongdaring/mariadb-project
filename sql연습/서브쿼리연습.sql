...
--
-- 1) select 절의 컬럼 프로젝션, insert into t values()
--
...
--
select a.n, a.s, a.r
	from (select now(), sysdate() as s, 3 +1 as r from dual) a;
    
--
-- 3) select의 where절(having 절)의 서브쿼리
--
...
where a.emp_no = b.emp_no
	...
	and b.to_date = '9999-01-01'
group by a.title
	having a.salary = (select min(m.avg_salary)
...
-- sol1) where절 subquery in, 복수형/복수컬럼
