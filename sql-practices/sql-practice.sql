...
select count(distinct emp_no) from salaries where salary >= 120000 and to_date = '9999-01-01';
...
select count(*) from titles where  to_date = '9999-01-01' and title like '%Engineer%';

-- 문제11
-- 사번이 13250(Zeydy)인 지원이 직책 변경 상황을 시간순으로 출력해보세요.
select from_date, to_date from titles where emp_no=13250 order by from_date asc; 
